...
const PAGES: Record<string, { title: string; body: string[] }> = {
  about: {
    title: "About Ecolution",
    body: [
      "Ecolution connects engineers, scientists, designers and operators with companies working directly on climate outcomes — carbon removal, renewable generation, grid software, water infrastructure and circular supply chains.",
  ...
  "climate-commitment": {
    ...
    body: [
      "Ecolution exists to shorten the distance between skilled people and the organisations that need them to hit climate targets.",
...
export async function generateMetadata({
  ...
  return { title: page ? `${page.title} | Ecolution` : "Not found | Ecolution" };
}
